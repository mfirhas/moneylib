...
// This exercises the visit_unit fallback in all Option<RawMoney> visitors.
// ---------------------------------------------------------------------------
...
fn test_option_str_code_visit_unit_via_custom_deserializer() {
    let result =
        crate::serde::raw_money::option_str_code::deserialize::<CHF, _>(VisitUnitDeserializer);
    assert!(result.unwrap().is_none());
}
...
fn test_option_str_symbol_visit_unit_via_custom_deserializer() {
    let result =
        crate::serde::raw_money::option_str_symbol::deserialize::<CHF, _>(VisitUnitDeserializer);
    assert!(result.unwrap().is_none());
}
