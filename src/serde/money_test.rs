...
fn test_str_code_serialize_chf() {
    ...
    let p = PaymentLocaleCode {
        amount: Money::<CHF>::from_decimal(dec!(1234.56)),
    };
    let json = serde_json::to_string(&p).unwrap();
    assert_eq!(json, r#"{"amount":"CHF 1'234.56"}"#);
}
...
fn test_str_code_deserialize_chf() {
    let p: PaymentLocaleCode = serde_json::from_str(r#"{"amount":"CHF 1'234.56"}"#).unwrap();
    assert_eq!(p.amount.amount(), dec!(1234.56));
...
fn test_str_code_deserialize_chf_wrong_currency() {
    let result: Result<PaymentLocaleCode, _> = serde_json::from_str(r#"{"amount":"EUR 1.234,56"}"#);
    assert!(result.is_err());
}
...
fn test_str_code_serialize_zero_chf() {
    let p = PaymentLocaleCode {
        amount: Money::<CHF>::from_decimal(dec!(0)),
    };
    let json = serde_json::to_string(&p).unwrap();
...
struct PaymentOptLocaleCode {
    #[serde(with = "crate::serde::money::option_str_code")]
    amount: Option<Money<CHF>>,
}

#[test]
fn test_option_str_code_serialize_some_chf() {
    let p = PaymentOptLocaleCode {
        amount: Some(Money::<CHF>::from_decimal(dec!(1234.56))),
    };
    let json = serde_json::to_string(&p).unwrap();
    assert_eq!(json, r#"{"amount":"CHF 1'234.56"}"#);
}
...
fn test_option_str_code_deserialize_some_chf() {
    let p: PaymentOptLocaleCode = serde_json::from_str(r#"{"amount":"CHF 1'234.56"}"#).unwrap();
    assert_eq!(p.amount.unwrap().amount(), dec!(1234.56));
}
...
fn test_str_symbol_deserialize_chf() {
    let p: PaymentLocaleSymbol = serde_json::from_str(r#"{"amount":"₣1'234.56"}"#).unwrap();
    assert_eq!(p.amount.amount(), dec!(1234.56));
    assert_eq!(p.amount.code(), "CHF");
}
...
fn test_str_symbol_deserialize_chf_wrong_symbol() {
    let result: Result<PaymentLocaleSymbol, _> = serde_json::from_str(r#"{"amount":"€1.234,56"}"#);
    assert!(result.is_err());
}
...
struct PaymentOptLocaleSymbol {
    #[serde(with = "crate::serde::money::option_str_symbol")]
    amount: Option<Money<CHF>>,
}
...
fn test_option_str_symbol_deserialize_some_chf() {
    let p: PaymentOptLocaleSymbol = serde_json::from_str(r#"{"amount":"₣1'234.56"}"#).unwrap();
    assert_eq!(p.amount.unwrap().amount(), dec!(1234.56));
}
...
// ---------------------------------------------------------------------------
// Custom deserializer that calls visit_unit (not visit_none) on deserialize_option.
// This exercises the visit_unit fallback in all Option<Money> visitors.
// ---------------------------------------------------------------------------

struct VisitUnitDeserializer;

impl<'de> serde::Deserializer<'de> for VisitUnitDeserializer {
...
#[test]
fn test_option_comma_str_code_visit_unit_via_custom_deserializer() {
    let result =
...
#[test]
fn test_option_comma_str_symbol_visit_unit_via_custom_deserializer() {
    let result =
...
#[test]
fn test_option_dot_str_code_visit_unit_via_custom_deserializer() {
    let result =
...
#[test]
fn test_option_dot_str_symbol_visit_unit_via_custom_deserializer() {
    let result =
...
#[test]
fn test_option_str_code_visit_unit_via_custom_deserializer() {
    let result = crate::serde::money::option_str_code::deserialize::<CHF, _>(VisitUnitDeserializer);
    assert!(result.unwrap().is_none());
}

#[test]
fn test_option_str_symbol_visit_unit_via_custom_deserializer() {
    let result =
        crate::serde::money::option_str_symbol::deserialize::<CHF, _>(VisitUnitDeserializer);
    assert!(result.unwrap().is_none());
}

#[test]
fn test_option_minor_visit_unit_via_custom_deserializer() {
