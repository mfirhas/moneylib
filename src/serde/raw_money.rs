...
pub mod comma_str_code {
    ...
    use crate::{Currency, MoneyFormatter, MoneyParser, RawMoney};
    ...
    impl<'de, C: Currency> de::Visitor<'de> for Visitor<C> {
        ...
        fn visit_str<E: de::Error>(self, v: &str) -> Result<Self::Value, E> {
            RawMoney::<C>::from_str_code_with(v, ",", ".").map_err(de::Error::custom)
        }
    }
...
pub mod comma_str_symbol {
    ...
    impl<'de, C: Currency> de::Visitor<'de> for Visitor<C> {
        ...
        fn visit_str<E: de::Error>(self, v: &str) -> Result<Self::Value, E> {
            RawMoney::<C>::from_str_symbol_with(v, ",", ".").map_err(|err| E::custom(err))
        }
    }
...
pub mod str_code {
    ...
    use crate::{BaseMoney, Currency, MoneyParser, RawMoney};
    ...
    impl<'de, C: Currency> de::Visitor<'de> for Visitor<C> {
        ...
        fn visit_str<E: de::Error>(self, v: &str) -> Result<Self::Value, E> {
            RawMoney::<C>::from_str_code(v).map_err(de::Error::custom)
        }
    }
...
pub mod str_symbol {
    ...
    impl<'de, C: Currency> de::Visitor<'de> for Visitor<C> {
        ...
        fn visit_str<E: de::Error>(self, v: &str) -> Result<Self::Value, E> {
            RawMoney::<C>::from_str_symbol(v).map_err(de::Error::custom)
        }
    }
...
pub mod minor {
    ...
    impl<'de, C: Currency> de::Visitor<'de> for Visitor<C> {
        ...
        fn visit_i64<E: de::Error>(self, v: i64) -> Result<Self::Value, E> {
            RawMoney::<C>::from_minor(i128::from(v)).map_err(de::Error::custom)
        }
        ...
        fn visit_i128<E: de::Error>(self, v: i128) -> Result<Self::Value, E> {
            RawMoney::<C>::from_minor(v).map_err(de::Error::custom)
        }

        fn visit_u128<E: de::Error>(self, v: u128) -> Result<Self::Value, E> {
            i128::try_from(v)
                .map_err(|_| de::Error::custom("value too large for minor amount"))
                .and_then(|n| RawMoney::<C>::from_minor(n).map_err(de::Error::custom))
        }
    }
