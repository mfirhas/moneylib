...
impl<C: Currency + Copy + 'static + Send + Sync> super::ObjMoney for RawMoney<C> {
    ...
    fn abs(&self) -> super::DynMoney {
        super::DynMoney::from_decimal_exact::<C>(BaseMoney::amount(&BaseOps::abs(self)))
    }

    #[inline]
    fn round(&self) -> super::DynMoney {
        super::DynMoney::from_decimal_exact::<C>(BaseMoney::amount(&BaseMoney::round(*self)))
    }

    #[inline]
    fn round_with(&self, decimal_points: u32, strategy: RoundingStrategy) -> super::DynMoney {
        super::DynMoney::from_decimal_exact::<C>(BaseMoney::amount(&BaseMoney::round_with(
            *self,
            decimal_points,
            strategy,
        )))
    ...
    fn truncate(&self) -> super::DynMoney {
        super::DynMoney::from_decimal_exact::<C>(BaseMoney::amount(&BaseMoney::truncate(self)))
    }

    #[inline]
    fn truncate_with(&self, scale: u32) -> super::DynMoney {
        super::DynMoney::from_decimal_exact::<C>(BaseMoney::amount(&BaseMoney::truncate_with(
            self, scale,
        )))
    }
    ...
    fn checked_add(&self, rhs: Decimal) -> Option<super::DynMoney> {
        Some(super::DynMoney::from_decimal_exact::<C>(BaseMoney::amount(
